   ...
   :_______:   :    StarsXTools ${version}
          ...
          :  /      WhatsApp: NOT FOUND
           :/       Telegram: @Ranzneweraa
                    Portable Tools DDoS By Ranzneweraa
========================================================================`)}
// [========================================] //
async function scrapeProxy() {
  try {
    const response = await fetch('https://www.freeproxy.world/?type=&anonymity=&country=&speed=&port=&page=100',
...
async function bootup() {
  try {
    ...
    const secretBangetJir = await fetch('https://raw.githubusercontent.com/wenzubot/security/main/text.txt');
    const password = await secretBangetJir.text();
    await console.log(`Login Key Required`)
    permen.question('[\x1b[1m\x1b[31mRanz Security\x1b[0m]: \n', async (skibidi) => {
      if (skibidi === password.trim()) {
        ...
        await sleep(700)
        console.clear()
        console.log(`Welcome To Ranz Tools ${version}`)
        await sleep(1000)
		    await banner()
...
Created And Coded Full By Ranzneweraa
...
Allah SWT
`
permen.question('[\x1b[1m\x1b[32mRanzneweraa Console\x1b[0m]: \n', (input) => {
...
${creatorCredits}`);
    ...
    console.log(`Ranzneweraa Ai Ragbot Started
